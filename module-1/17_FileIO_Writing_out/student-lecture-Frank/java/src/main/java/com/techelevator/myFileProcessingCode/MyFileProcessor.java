...
public class MyFileProcessor {
	...
	public static void main(String[] args) throws IOException { // IOException is a super class of all I/O Exceptions
		...
		if (!myFile.exists() || !myFile.isFile()) {
			...
			System.exit(16);   // terminate program w/ a return code 16
							   // When a program uses the exist() method an optional
							   ...
							   // The meaning of the return value depends on the script that is running the program
							   // Return codes are usually a multiple of 4 - a tradition from ancient days of programming
		...
		// Define the output file that we are writing the program to
		...
		fileWriter.close();	// release the resources & write any data in the buffer to the file
