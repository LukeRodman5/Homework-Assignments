...
public class LectureTest { // class to hold all of the unit tests
	...
	@Before // Do this before every unit test - any setup required for each test - define int vars, gather some data
	public void setup() {				// method name doesn't matter as long as it's descriptive
		System.out.println("setup");	// not usually done - this is here for illustration purposes
	}
	...
	@After
	public void teardown() {			// method name doesn't matter as long as it's descriptive
