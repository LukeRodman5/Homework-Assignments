...
public class CommandLineSampleProgram {
	...
	public static void main(String[] args) {
		...
		int aNumber = userInput.nextInt();                           // Get a line from the keyboard
		userInput.nextLine(); 										// remove the (enter) thats left in the keyboard buffer by nextInt
		...
		while(true) {  // loop until the end of time or we break out of the loop
			...
			// to test a String for equals we CANNOT use the normal == aline - We learn why on Monday
