...
public class Exercises {
	 ...
	 *
	 * The animal name should be case insensitive so "elephant", "Elephant", &
	...
	public String animalGroupName(String animalName) {
		...
		animalToGroup.put("crocodile", "Float");
			...
			String groupName = animalToGroup.get(animalName); 
			
			if (groupName == null) { //null means it (in this case the animal name) did not exist in the key
				groupName = "unknown";
			}
	 ...
	 * "BATH0073" -> 0.15
	 *chen4
	 * The item number should be case insensitive so "kitchen4001", "Kit001", & "KITCHEN4001"
	...
	/*
	 * Modify & return the given Map as follows: if "Peter" has more than 0 money, transfer half of it to "Paul",
	...
	/*
	 * Modify & return the given Map as follows: if "Peter" has $50 or more, AND "Paul" has $100 or more,
	 ...
	 * there is a key of its first character w/ the value of its last character.
	 *
	...
	/*
	 * Given an array of Strings, return a Map < String, Integer > with a key for each different String, w/ the value the
	...
	/*
	 * Given an array of Strings, return a Map < String, Boolean > where each different String is a key & value
	 ...
	 * & their int values, are added to the int values of matching keys in Map1. Return the new Map.
	 *
	 * Unmatched keys & their int values in Map2 are simply added to Map1.
	 *
	 ...
	 * in the String & also as the last 2 chars of the String, so "hixxxhi" yields 1.
	 *
	 * We don't count the end subString, but the subString may overlap a prior position by one.  For instance, "xxxx"
	 * has a count of 2, one pair at position 0, & the second at position 1. The third pair at position 2 is the
	 * end subString, which we don't count.
	 *
	 * Return Map < String, Integer >, where the key is String from the array, & its last2 count.
	 *
	 * last2Revisited(["hixxhi", "xaxxaxaxx", "axxxaaxx"]) => {"hixxhi": 1, "xaxxaxaxx": 1, "axxxaaxx": 2}
	 *
	 * extra step of comparing segments of the string
	 */
