...
public class UsePlayingCards {
	...
	aSwissCard3.value = 11; // ok since value is defined as protected in the superclass
	
	
		//							new Collection(what-it-holds)
		List<PlayingCard> someCards = new ArrayList<PlayingCard>(); // By using the superclass as type - put subclass objects in it
		// someCards is an object type ArrayList of PlayingCard type objects - a subclass object includes the superclass type
