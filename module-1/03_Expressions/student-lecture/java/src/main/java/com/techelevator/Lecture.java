...
public class Lecture {
    ...
    */
    ...
    public int returnNotOne() { // my name is returnNotOne & I will return an int & receive no parameters
        return 2;
    }
    ...
    */
    ...
    //because all possible conditions are handled in the if, this is unreachable code
