...
public class LectureTest {
	// Instantiating the lecture code stored in class lecture
    ...
    }	// check to see if the value returned from the returnNotOne() method is NoEqual 1

    @Test
    public void testReturnNotHalf() {			// testing the returnNotHalf() method from the lecture code
