...
// an application program to instantiate & use the PlayingCard objects
	...
	public static void main(String[] args) {
		...
		// Using a PlayingCard method w/ an AmericanPlayingCard object
		aUSACard2.setValue(4);	// Using a superclass method w/ a subclass object
		System.out.println("aUSACard2 is : \n" + aUSACard2);
