...
public class ExceptionsLecture {
	...
	public static void main(String[] args) {
		...
		try { // If the code in this clock throws an Exception
		      // 	Let me see if I can handle instead of the system terminating the program
		...
		} catch(ArrayIndexOutOfBoundsException e) { // An Exception object is automatically passed to the catch block
			// An Exception contains information about the exception that you might want to know
			// Flow of control resumes here after the Exception is thrown
			System.out.println("XXX   Uh-oh, something went wrong...   XXX"); // if this Exception occurs in the preceding try block, I'll handle it
		...
		try {
			...
			doSomethingDangerous();  // throws an ArrayIndexOutOfBoundsException - which will be caught by this catch block
			System.out.println("See, I told you nothing would go wrong!");
		} catch(ArrayIndexOutOfBoundsException exceptionObject) {// will catch the Exception if this anything in this try block throws it  
