...
<script>
  export default {
    name:'book-card',
    props:["book"],
    methods:{toggleReadStatus() {this.$store.commit("FLIP_READ_STATE",this.book)}}};
</script>
<style>
  .card {
      ...
      height:550px;
      margin:20px;}
  .card.read {background-color: lightgray;}
  .card.book-title {font-size: 1.5rem;}
  .card.book-author {font-size: 1rem;}
</style>