...
function returnBeforeEnd(firstParameter, secondParameter) {
  ...
  return firstParameter + secondParameter; //terminate the function & return to caller
}
...
function allDivisibleByThree(numberToFilter){
  // return an arry of only the numbers divisible by 3 in the argument array
  return numbersToFilter.filter((anElement) => {
                                                if (anElement %3 === 0) { // if anElement is evenly divisible by 3
                                                  return true;            //  tell filter to add to a new array (we want it)
                                                }
                                                else {                    // if not...
                                                  return false;           //  tell filter not to add to a new array (we don't want it)                                               
