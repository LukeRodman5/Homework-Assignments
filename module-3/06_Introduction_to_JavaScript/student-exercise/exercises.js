...
function isEven(num){if (num%2 ===0){
	return num;}}
	 const isEvenOnly = input.filter(isEven);
	return isEvenOnly;}
...
function isAMultiple(num) {if (num % x === 0){
	return num;}}
