...
function variables() {
  ...
  /* 1. Enclose what you wanted to display in the back-tips(') */
...
console.table(WEEKDAYS) /* display the aray as a table */
...
function stringFunctions(value) {
 ...
 for (let i=0; person.employees.length; i++){
   console.log('Employee #${i+1}: $(person.employees[1]}'')
 }
 ...
 * ##########################
 * Java has a library of functions to make using Arrays easier */
...
function arrayFunctions(){
  ...
  let old funnyGuys= stooges.concat(marxBros)
