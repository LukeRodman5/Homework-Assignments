...
/* Integration Testing - Testing to ensure that your code interacts w/ external processes correctly
 * 
 * You want to be sure that your code doesn't break when working w/ external code
 * 
 * Unit Testing - ensures that your class methods work as intended within the context of the application program
 * 
 * When using DAOs, we are interacting w/ an external resource/ process called a data base manager
 * 
 * We need to verify any insert, update, or delete we do was done correctly in the database manager
 * 
 * You can use the DAO interface to determine which methods you need to test - they interact w/ the database
 * 
 * We will use JUnit w/ some additional techniques & methods
 * 
 * 
 */
...
public class JDBCCityDAOIntegrationTest {
    ...
    * session and hence the same database transaction */
    ...
    /* Before any tests are run, this method initializes the data-source for testing. */
    @BeforeClass
