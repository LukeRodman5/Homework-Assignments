...
public class ProjectsCLI {
	...
	private void displayApplicationBanner() {
		...
		System.out.println("| |__   _ __ ___   _ __  | |  ___   __   _  ___   ___   | |__) ||__ ___  _  ___   ___ _| |_  | || | || |_) |");
		System.out.println("|  __| | '_ ` _ \\| '_ \\| |// _ \\|| | | |/ _ \\/ _ \\ |  ___//'__/_ \\| |/ _ \\/  _|_  __| | || | ||  _ <");
		System.out.println("| |____| | | | | || |_)||| || (_) ||| |_| || __//|  _// | ||  | || (_) || || __//| (__ | |__ | ||_| || |_) |");
		System.out.println("|______|_| |_| |_|| .__//|_|\\___//\\__,  |\\___|\\___|||_||  |_|\\___//| |\\___|\\___|\\___||_____//|____//");
