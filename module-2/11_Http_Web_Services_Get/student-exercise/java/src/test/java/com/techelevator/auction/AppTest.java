...
public class AppTest {
        ...
        public void listAllAuctions() {
        	// Arrange
            when(mockRestTemplate.getForObject(eq(AuctionService.API_URL), eq(Auction[].class)))
            ...
            // Assert
            assertEquals("AuctionService.BASE_URL is not valid. Must be '" + EXPECTED_API_URL + "'", EXPECTED_API_URL, AuctionService.API_URL);
        ...
        public void listDetailsForAuction() {
        	// Arrange
        	when(mockRestTemplate.getForObject(eq(AuctionService.API_URL + "/1"), eq(Auction.class)))
        ...
        public void findAuctionsSearchTitle() {
        	// Arrange
        	when(mockRestTemplate.getForObject(eq(AuctionService.API_URL + "?title_like=Zero"), eq(Auction[].class)))
        		.thenReturn(expectedAuctions);
            auctionService.restTemplate = mockRestTemplate;
        ...
        public void findAuctionsSearchTitleNotFound() {
        	// Arrange
        	when(mockRestTemplate.getForObject(eq(AuctionService.API_URL + "?title_like=NoSuchTitle"), eq(Auction[].class)))
        		.thenReturn(new Auction[0]);
            auctionService.restTemplate = mockRestTemplate;
        ...
        public void findAuctionsSearchPrice() {
        	// Arrange
        	when(mockRestTemplate.getForObject(eq(AuctionService.API_URL + "?currentBid_lte=23.25"), eq(Auction[].class)))
        		.thenReturn(expectedAuctions);
            auctionService.restTemplate = mockRestTemplate;
        ...
        public void findAuctionsSearchPriceNotFound() {
        	// Arrange
        	when(mockRestTemplate.getForObject(eq(AuctionService.API_URL + "?currentBid_lte=0.0"), eq(Auction[].class)))
        		.thenReturn(new Auction[0]);
            auctionService.restTemplate = mockRestTemplate;
