...
public class App {
    ...
    public static void main(String[] args) {
        ...
        AuctionService auctionService = new AuctionService(API_URL);
        ...
        while (true) {
            ...
            if (menuSelection == 1) {
                ...
                Auction auction = auctionService.addAuction(newAuctionString);
            	...
            	if (auctions != null) {
                    ...
                    if (auction != null) {
                        ...
                        auction = auctionService.updateAuction(CSV);
