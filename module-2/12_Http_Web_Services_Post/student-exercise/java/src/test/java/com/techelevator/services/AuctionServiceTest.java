...
public class AuctionServiceTest {
    ...
    public void setUp() {
        ...
        auctionService = new AuctionService(EXPECTED_API_URL);
    }
    ...
    public void add_should_return_new_auction() {
        ...
        // Act
        Auction actualAuction = auctionService.addAuction(testAddString);
    ...
    public void update_should_return_updated_auction() {
        ...
        // Act
        Auction updatedAuction = auctionService.updateAuction(testUpdateString);
