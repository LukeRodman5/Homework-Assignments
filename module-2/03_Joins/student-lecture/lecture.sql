...
--
--
--Modern Syntax you CANNOT forget the join condition - it is coded in an ON clause
--
--
--  SELECT columns
--    FROM table1
...
-- ********* INNER JOIN ***********
--
-- last name is in actor table
-- film title is in the film table
-- no direct link between actor & film
-- so we used the indirect link the film_actor table
--
--
--
-- Show the last_name of all the actors in the movie FINDING ANACONDA
SELECT lastname         -- columns in the result
 FROM actor
  film_actor
