...
public class HotelController {
    ...
    private HotelDAO hotelDAO;					// Reference the HotelDAO so we can use it's methods
    private ReservationDAO reservationDAO;		// Reference to the ReservationDAO so we can use it's methods

    // Send to the constructor of this class a HotelDAO & a ReservationDAO
    //Spring MVC dependency injection automatically instantiates a HotelDAO object
    //					& ReservationDAO object & passes them to the constructor
    //
    // We do not instantiate the DAO object used by the controller - Spring MVC does this automatically
    ...
    //The @Valid annotation in the parameter list of the methods to 
