...
public class MemoryReservationDAO implements ReservationDAO {
    ...
    private HotelDAO hotelDAO;	// Defines a reference to the HotelDAO -to use the HotelDAO methods

    public MemoryReservationDAO(HotelDAO hotelDAO) {	// The constructor receives a HotelDAO object as a parameter
        this.hotelDAO = hotelDAO;						// Assigns the HotelDAO object it receives, to the HotelDAO reference
