...
-- 5.Select name, country code, and population of all cities with a population greater than 8 million people (10 rows)
...
SELECT name, continent, GNP > 1000000
 FROM country
  WHERE GNP > 1000000;
