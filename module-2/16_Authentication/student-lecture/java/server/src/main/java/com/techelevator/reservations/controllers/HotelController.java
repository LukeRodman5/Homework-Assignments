...
// This will handle all API calls for the class for /hotels path

@RestController
@PreAuthorize("isAuthenticated()") // Also Spring to verify whomever wants to use any of these methods			
								   // in this controller is authorized to do so - has done a successful login
public class HotelController {
     ...
     */
   @PreAuthorize("permitAll()")	// Allows anyone regardless of their login status  to access this method
